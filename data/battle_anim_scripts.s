...
Move_QUIVER_DANCE:
	...
	playsewithpan SE_M_TELEPORT, 192
	delay 8
	createvisualtask AnimTask_BlendPalInAndOutByTag, 5, 10249, 0x3E0, 14, 0, 3
	createsprite gDragonDanceOrbSpriteTemplate, ANIM_ATTACKER, 2, 0
	createsprite gDragonDanceOrbSpriteTemplate, ANIM_ATTACKER, 2, 43
	createsprite gDragonDanceOrbSpriteTemplate, ANIM_ATTACKER, 2, 85
	createsprite gDragonDanceOrbSpriteTemplate, ANIM_ATTACKER, 2, 128
...
Move_COIL:
	...
	createsprite gConstrictBindingSpriteTemplate, ANIM_TARGET, 3, 0, -8, 1, 2
	delay 8
	createvisualtask AnimTask_CurseBlendEffect, 2, 4, 2, 2, 0, 12, 0x7FFF
...
Move_MIDELE_POWER:
	...
	fadetobg BG_HIGHSPEED_OPPONENT
BlizzardContinueMidele:: @ 81CE77E
	waitbgfadeout
	createvisualtask AnimTask_StartSlidingBg, 5, -2304, 0, 1, -1
	waitbgfadein
	waitforvisualfinish
...
_GunkShotSubcall:
	playsewithpan SE_M_BUBBLE3, 192
	createsprite gSludgeProjectileSpriteTemplate, ANIM_BATTLER_TARGET, 3, 10, 0, 0, 0, 20, 0
	delay 1
	return
	end
...
@createsprite gBattleAnimSpriteTemplate_LeafStorm2, ANIM_TARGET, 2, 1, 1, -24, 12, 10
@createsprite gBattleAnimSpriteTemplate_LeafStorm2, ANIM_TARGET, 2, 1, 1, -24, -12, 10
@playsewithpan SE_M_RAZOR_WIND2, 63
@delay 2
...
Move_HOLA_REINA:
	...
	createsprite gRedHeartRisingSpriteTemplate, ANIM_ATTACKER, 40, 200, 272, 90
	delay 75
	createvisualtask AnimTask_CurseBlendEffect, 2, 4, 4, 4, 0, 10, RGB(31, 25, 27)
	waitforvisualfinish
...
Move_FLARE_BLITZ:
	...
	playsewithpan SE_M_COMET_PUNCH, +63
	createvisualtask AnimTask_BlendSelected, 10, 4, 2, 0, 0, RGB_BLACK
	playsewithpan SE_M_COMET_PUNCH, +63
	waitforvisualfinish
	createsprite gSlideMonToOriginalPosSpriteTemplate, ANIM_ATTACKER, 2, 0, 0, 9
	waitforvisualfinish
...
Move_ICE_SHARD:
	...
	fadetobg BG_ICE
	waitbgfadein
	createsoundtask SoundTask_LoopSEAdjustPanning, 183, SOUND_PAN_ATTACKER, SOUND_PAN_TARGET, 4, 4, 0, 10
...
Move_MIRROR_SHOT:
	...
	loadspritegfx ANIM_TAG_IMPACT 
	loadspritegfx ANIM_TAG_WHITE_CIRCLE_OF_LIGHT 
	createvisualtask AnimTask_BlendExcept, 5, 5, 5, 2, 0, 10, -1  
...
SetBugBg:
	...
	createvisualtask AnimTask_GetAttackerSide, 2
	jumpargeq 7, 0, SetBugBgPlayer  @ 7, 0, ???
	fadetobg BG_BUG_OPPONENT
	waitbgfadeout
	createvisualtask AnimTask_StartSlidingBg, 5, 1536, 0, 0, -1
	goto SetBugBgFade

const u8 *const gMonFootprintTable[] =
{
  ...
  /*  [SPECIES_REGIELEKI] = gMonFootprint_Regieleki,
    ...
    [SPECIES_PUPPERON] = gMonFootprint_Pupperon,
    [SPECIES_VULPIII] = gMonFootprint_Vulpiii,
    [SPECIES_KOLTA] = gMonFootprint_Kolta,
    [SPECIES_PARASPOR] = gMonFootprint_Paraspor,
    [SPECIES_COINPUR] = gMonFootprint_Coinpur,
    [SPECIES_DODAERIE] = gMonFootprint_Dodaerie,
    [SPECIES_WARFURS] = gMonFootprint_Warfurs,

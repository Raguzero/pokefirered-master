...
static const u8 sPlusDescription[] = _("Ups SP.ATK with MINUS.");
static const u8 sMinusDescription[] = _("Ups SP.ATK with PLUS.");
...
static const u8 sMummyDescription[] = _("Spreads MUMMY with contact.");
...
static const u8 sCursedBodyDescription[] = _("Can disables a move on contact.");
static const u8 sDrySkinDescription[] = _("Sun: lost HP. Rain: gain HP. WATER heals.");

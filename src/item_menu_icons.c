...
static const void *const sItemIconGfxPtrs[][2] = {
    ...
    {gItemIcon_AbilityCapsule, gItemIconPalette_AbilityCapsule},
    {gItemIcon_DestinyKnot, gItemIconPalette_DestinyKnot},
    {gFile_graphics_items_icons_vitamin_sheet, gItemIconPalette_GProtein},
    {gFile_graphics_items_icons_vitamin_sheet, gItemIconPalette_GIron},
    {gFile_graphics_items_icons_vitamin_sheet, gItemIconPalette_GCarbos},
    {gFile_graphics_items_icons_vitamin_sheet, gItemIconPalette_GCalcium},
    {gFile_graphics_items_icons_vitamin_sheet, gItemIconPalette_GZinc},
    {gFile_graphics_items_icons_hp_up_sheet, gItemIconPalette_GHPUp},
    {gFile_graphics_items_icons_rare_candy_sheet, gItemIconPalette_GoldenCandy},
    {gItemIcon_SweetHeart, gItemIconPalette_SweetHeart},
    {gItemIcon_SecretPotion, gItemIconPalette_SecretPotion},
    ...
    {gItemIcon_DuskStone, gItemIconPalette_DuskStone},
    {gItemIcon_ShinyStone, gItemIconPalette_ShinyStone},
    {gItemIcon_IceStone, gItemIconPalette_IceStone},
    ...
    {gItemIcon_ChoiceScarf, gItemIconPalette_ChoiceScarf},
    {gItemIcon_ChoiceSpecs, gItemIconPalette_ChoiceSpecs},
    {gItemIcon_FocusSash, gItemIconPalette_FocusSash},
    {gItemIcon_PowerHerb, gItemIconPalette_PowerHerb},
    {gItemIcon_PinkPetal, gItemIconPalette_PinkPetal},
    {gItemIcon_PsycheArmor, gItemIconPalette_PsycheArmor},
    {gItemIcon_LevelCap, gItemIconPalette_LevelCap},
    {gFile_graphics_items_icons_question_mark_sheet, gFile_graphics_items_icon_palettes_question_mark_palette},
    {gFile_graphics_items_icons_question_mark_sheet, gFile_graphics_items_icon_palettes_question_mark_palette},
    {gFile_graphics_items_icons_question_mark_sheet, gFile_graphics_items_icon_palettes_question_mark_palette},
    {gFile_graphics_items_icons_question_mark_sheet, gFile_graphics_items_icon_palettes_question_mark_palette},

...
const u8 sDAZZLING_GLEAMDescription[] = _("Damages foes by\nemitting a bright flash.");
const u8 sBRAVE_BIRDDescription[] = _("A low altitude charge\nthat also hurts the user.");
const u8 sX_SCISSORDescription[] = _("Slashes the foe with\ncrossed scythes, claws, etc.");
const u8 sIRON_HEADDescription[] = _("Slams the foe with\na hard head.\nMay cause flinching.");
const u8 sSTONE_EDGEDescription[] = _("Stabs the foe with stones.\nHigh critical-hit ratio.");
...
const u8 sHEAL_PULSEDescription[] = _("Recovers up to half\nthe target's maximum HP.");
const u8 sMidelePowerDescription[] = _("MICOLO's ultimate attack.\nRaises all stats by one.");
...
const u8 sBulletPunchDescription[] = _("Punches as fast\nas a bullet.\nIt always hits first.");

...
const u8 sFAIRY_WINDDescription[] = _("Stirs up a fairy wind to\nstrike the foe.");
const u8 sMOONBLASTDescription[] = _("Attacks with the power of\nthe moon. May lower SP. ATK.");
const u8 sDAZZLING_GLEAMDescription[] = _("Damages foes by emitting\na bright flash.");
const u8 sBRAVE_BIRDDescription[] = _("A low altitude charge that\nalso hurts the user.");
const u8 sX_SCISSORDescription[] = _("Slashes the foe with crossed\nscythes, claws, etc.");
const u8 sIRON_HEADDescription[] = _("Slams the foe with a hard\nhead. May cause flinching.");
const u8 sSTONE_EDGEDescription[] = _("Stabs the foe with stones.\nHigh critical-hit ratio.");
const u8 sDARK_PULSEDescription[] = _("Attacks with a horrible\naura. May cause flinching.");
const u8 sENERGY_BALLDescription[] = _("Draws power from nature to\nattack. May lower SP. DEF.");
const u8 sNASTY_PLOTDescription[] = _("Thinks bad thoughts to\nsharply boost SP. ATK.");
const u8 sQUIVER_DANCEDescription[] = _("Dances to raise Sp. Atk,\nSp. Def and Speed.");	
const u8 sCOILDescription[] = _("Coils up to raise ATTACK\nDEFENSE and ACCURACY.");
const u8 sSHADOW_SNEAKDescription[] = _("Extends the user's shadow\nto strike first.");
const u8 sROCK_POLISHDescription[] = _("Polishes the body to\nsharply raise SPEED.");
const u8 sBOOMBURSTDescription[] = _("Attacks everything with a\ndestructive sound wave.");
const u8 sOVERDRIVEDescription[] = _("Attack everything causing a\nhuge echo and vibration.");
const u8 sLIGHTOFRUINDescription[] = _("Fires a great beam of light\nthat also hurts the user.");
const u8 sHEADSMASHDescription[] = _("A life-risking headbutt that\nseriously hurts the user.");
const u8 sHEAL_PULSEDescription[] = _("Recovers up to half the\ntarget's maximum HP.");
const u8 sMidelePowerDescription[] = _("MICOLO's ultimate attack.\nRaises all stats by one.");
const u8 sGUNK_SHOTDescription[] = _("Shoots filthy garbage at\nthe foe. May also poison.");
const u8 sTHUNDER_CAGEDescription[] = _("Trap the foe in a cage of\nsparks for 4-5 turns.");
const u8 sDRAGON_ENERGYDescription[] = _("Inflicts more damage if the\nuser's HP is high.");
const u8 sELECTROWEBDescription[] = _("Snares the foe with an\nelectric net. Lowers SPEED.");
const u8 sGRAV_APPLEDescription[] = _("Drops an apple from above.\nLowers the foe's DEFENSE.");
const u8 sAPPLE_ACIDDescription[] = _("Attacks with tart apple acid\nto lower the foe's SP. DEF.");
const u8 sACCELEROCKDescription[] = _("Hits with a high-speed\nrock that always goes first.");
const u8 sDARKTHUNDERDescription[] = _("DARK PIKA's ultimate attack.\nIt hits twice.");
const u8 sDRILL_RUNDescription[] = _("Spins its body like a drill.\nHigh critical-hit ratio.");
const u8 sLEAF_STORMDescription[] = _("Allows a full-power attack,\nbut sharply lowers SP. ATK.");
const u8 sSHORE_UPDescription[] = _("Restores the user's HP.\nMore HP in a sandstorm.");
const u8 sDRAGON_HAMMERDescription[] = _("Swings its whole body\nlike a hammer to damage.");
const u8 sMONADO_POWERDescription[] = _("The Monado's power. Varies\nwith its wielder's will.");
...
const u8 sHOLA_REINADescription[] = _("Inflicts damage identical\nto the user's level.");

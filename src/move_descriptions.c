...
const u8 sBRUTAL_BALLDescription[] = _("MICOLO's ultimate attack.\nCan FRZ, BRN, or PRZ.");
const u8 sSEISMIC_PUNCHDescription[] = _("MICOLO's ultimate attack.\nPunch that shakes the earth.");
...
const u8 sFocusBlastDescription[] = _("Attacks at full power.\nMay lower SP.DEF.");

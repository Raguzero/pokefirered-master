...
const u8 gMoveDescription_VoltTackle[] = _("A charge that may\nparalyze the foe.\nAlso hurts the\nuser.");
...
const u8 sFAIRY_WINDDescription[] = _("Stirs up a fairy\nwind to strike\nthe foe.");
const u8 sMOONBLASTDescription[] = _("Attacks with the\npower of the moon.\nMay lower SP.ATK.");
const u8 sDAZZLING_GLEAMDescription[] = _("Damages foes by\nemitting a\nbright flash.");
const u8 sBRAVE_BIRDDescription[] = _("A low altitude\ncharge that also\nhurts the user.");
const u8 sX_SCISSORDescription[] = _("Slashes the foe\nwith crossed\nscythes, claws,\netc.");
const u8 sIRON_HEADDescription[] = _("Slams the foe with\na hard head.\nMay cause flinch.");
const u8 sSTONE_EDGEDescription[] = _("Stabs the foe\nwith stones.\nHigh CRIT ratio.");
const u8 sDARK_PULSEDescription[] = _("Attacks with a\nhorrible aura.\nMay cause flinch.");
const u8 sENERGY_BALLDescription[] = _("Draws power from\nnature to attack.\nMay lower SP.DEF.");
const u8 sNASTY_PLOTDescription[] = _("Thinks bad thoughts\nto sharply boost\nSP.ATK.");
const u8 sQUIVER_DANCEDescription[] = _("Dances to raise\nSP.ATK, SP.DEF\nand SPEED.");	
const u8 sCOILDescription[] = _("Coils up to raise\nATTACK, DEFENSE\nand ACCURACY.");
const u8 sSHADOW_SNEAKDescription[] = _("Extends the user's\nshadow to strike\nfirst.");
const u8 sROCK_POLISHDescription[] = _("Polishes the body\nto sharply raise\nSPEED.");
const u8 sBOOMBURSTDescription[] = _("Attacks everything\nwith a destructive\nsound wave.");
const u8 sOVERDRIVEDescription[] = _("Attack everything\ncausing a huge echo\nand vibration.");
const u8 sLIGHTOFRUINDescription[] = _("Fires a great\nbeam of light that\nalso hurts the user.");
const u8 sHEADSMASHDescription[] = _("A life-risking\nheadbutt that hard\nhurts the user.");
const u8 sHEAL_PULSEDescription[] = _("Recovers up to\nhalf the target's\nmaximum HP.");
const u8 sMidelePowerDescription[] = _("MICOLO's ultimate\nattack. Raises all\nstats by one.");
const u8 sGUNK_SHOTDescription[] = _("Shoots filthy\ngarbage at the foe.\nMay also poison.");
const u8 sTHUNDER_CAGEDescription[] = _("Trap the foe in\na cage of\nsparks for 4-5 turns.");
const u8 sDRAGON_ENERGYDescription[] = _("Inflicts more damage\nif the user's\nHP is high.");
const u8 sELECTROWEBDescription[] = _("Snares the foe with\nan electric net.\nLowers SPEED.");
const u8 sGRAV_APPLEDescription[] = _("Drops an apple\nfrom above.\nLowers the foe's DEFENSE.");
const u8 sAPPLE_ACIDDescription[] = _("Attacks with tart\napple acid to\nlower the foe's SP.DEF.");
const u8 sACCELEROCKDescription[] = _("Hits with a high\nspeed rock that\nalways goes first.");
const u8 sDARKTHUNDERDescription[] = _("DARK PIKA's\nultimate attack.\nIt hits twice.");
const u8 sDRILL_RUNDescription[] = _("Spins its body\nlike a drill.\nHigh CRIT ratio.");
const u8 sLEAF_STORMDescription[] = _("Allows a full-power\nattack, but sharply\nlowers SP.ATK.");
const u8 sSHORE_UPDescription[] = _("Restores the user's HP.\nMore HP in a sandstorm.");
const u8 sDRAGON_HAMMERDescription[] = _("Swings its whole\nbody like a hammer\nto damage.");
const u8 sMONADO_POWERDescription[] = _("The Monado's power.\nVaries with its\nwielder's will.");
const u8 sBRUTAL_BALLDescription[] = _("MICOLO's ultimate\nattack. Can FRZ,\nBRN, or PRZ.");
const u8 sSEISMIC_PUNCHDescription[] = _("MICOLO's ultimate\nattack. Punch that\nshakes the earth.");
const u8 sHOLA_REINADescription[] = _("Inflicts damage\nidentical to the\nuser's level.");
const u8 sFlareBlitzDescription[] = _("A charge that may\nburn the foe. Also\nhurts the user.");
const u8 sAuraSphereDescription[] = _("Attacks with an\naura blast that\ncannot be evaded.");
const u8 sPoisonJabDescription[] = _("A stabbing attack\nthat may poison\nthe foe.");
const u8 sSeedBombDescription[] = _("A barrage of\nhard seeds is fired\nat the foe.");
const u8 sBugBuzzDescription[] = _("A damaging sound\nwave that may\nlower SP.DEF.");
const u8 sDragonPulseDescription[] = _("Generates a\nshock wave to\ndamage the foe.");
const u8 sPowerGemDescription[] = _("Attacks with rays\nof light that sparkle\nlike diamonds.");
const u8 sVacuumWaveDescription[] = _("Whirls its fists\nto send a wave\nthat strikes first.");
const u8 sFocusBlastDescription[] = _("Attacks at full\npower. May lower\nSP.DEF.");
const u8 sEarthPowerDescription[] = _("Makes the ground\nerupt with power.\nMay lower SP.DEF.");
const u8 sPsychicFangsDescription[] = _("Chomps with psychic\nfangs. Destroys any\nbarriers.");
const u8 sIceShardDescription[] = _("Hurls a chunk of\nice that always\nstrike first.");
const u8 sShadowClawDescription[] = _("Strikes with\na shadow claw.\nHigh CRIT ratio.");
...
const u8 sShadowBoneDescription[] = _("Strikes with a\nhaunted bone.\nMight drop DEFENSE.");
const u8 sJungleHealingDescription[] = _("Heals HP and\nstatus of itself\nand allies in battle.");
const u8 sRazorShellDescription[] = _("Tears at the foe\nwith sharp shells.\nMay lower DEFENSE.");
const u8 sWoodHammerDescription[] = _("Slams the body into\na foe.The user\ngets hurt too.");
const u8 sStruggleBugDescription[] = _("Resisting, the user\nattacks the foe.\nLowers SP.ATK.");
const u8 sNightSlashDescription[] = _("Hits as soon as\npossible. High CRIT\nratio.");
const u8 sHexDescription[] = _("Does double damage\nif the foe has\na status problem.");
...
const u8 sFieryWrathDescription[] = _("An attack fueled\nby your wrath.\nMay cause flinch.");
const u8 sThunderousKickDescription[] = _("Uses a lightning\nlike kick to hit.\nLowers foe's\nDEFENSE.");
const u8 sFreezingGlareDescription[] = _("Shoots psychic\npower from the\neyes. May freeze\nthe foe.");

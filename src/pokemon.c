...
const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES] = // Assigns all species to the National Dex Index (Summary No. for National Dex)
{
   ...
   /* SPECIES_TO_NATIONAL(REGIELEKI),
	...
	SPECIES_TO_NATIONAL(MOLAMBINO), // Pez ancla
	SPECIES_TO_NATIONAL(ANGORE), // Evo Molambino
	SPECIES_TO_NATIONAL(LUREEL), // Evo Lureel
	...
	SPECIES_TO_NATIONAL(PIKACHU_GIGA),
	SPECIES_TO_NATIONAL(EEVEE_GIGA),
